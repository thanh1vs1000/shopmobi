...
if(isset($_POST['submit'])){
    ...
    if(isset($ten_sp) && isset($gia_sp) && isset($bao_hanh) && isset($phu_kien) && 
            isset($tinh_trang) && isset($khuyen_mai) && isset($trangthai)&& isset($anh_sp) && isset($id_dm) && isset($dac_biet)){
        move_uploaded_file($tmp_name, 'anh/'.$anh_sp);
        $sql="INSERT INTO sanpham(ten_sp,gia_sp,bao_hanh,phu_kien,tinh_trang,khuyen_mai,trangthai,"
                . "chi_tiet_sp,anh_sp,id_dm,dac_biet) VALUES('$ten_sp','$gia_sp','$bao_hanh','$phu_kien','$tinh_trang',"
                . "'$khuyen_mai','$trangthai',"
                ...
                <form method="post" enctype="multipart/form-data" role="form">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="trangthai" value="Còn hàng" required="">
                        </div>
                        <div class="form-group">
